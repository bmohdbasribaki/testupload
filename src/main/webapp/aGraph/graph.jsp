...
<!--                        <li  id="dropDownIndex">
                        ...
                        <li class="dropdown" id="dropDownTabular">
                            <a href="<%=inBasePath%>tTabular/tabular.jsp" ><i class="icon-subtitles"></i>Tabular Table </a>
                                                    ...
                                                    <div class="chat-body">
                                                        <div class="chat-message">
                                                            ...
                                                            <%
                                                                ...
                                                                int easyPass = 0,medPass = 0,hardPass = 0;
                                                                while (j < ls.size()) {
                                                                    if (ls.get(j).getFmlcDifficulty().equalsIgnoreCase("easy")) {
                                                                       //check session required pass or not
                                                                        if(ls.get(j).getFmlcSessionPass() == 10){
                                                                            %>
                                                                            <p> <%=ls.get(j).getFmlcSessionMsg()%></p>
                                                                            <%
                                                                        }else if(ls.get(j).getFmlcScorePass()== 11 || ls.get(j).getFmlcScorePass() == 10) {   
                                                                             %>
                                                                            <p> <%=ls.get(j).getFmlcScoreMsg()%></p>
                                                                            <p><%=ls.get(j).getFmlcSuggestMsg()%></p>
                                                                            <%
                                                                        }else if(ls.get(j).getFmlcScorePass() == 14){
                                                                            easyPass = 1;
                                                                        }
                                                                    }

                                                                    if(easyPass == 1){
                                                                        if (ls.get(j).getFmlcDifficulty().equalsIgnoreCase("medium")){
                                                                            if(ls.get(j).getFmlcSessionPass() == 20){
                                                                                %>
                                                                                <p> <%=ls.get(j).getFmlcSessionMsg()%></p>
                                                                                <%
                                                                            }else if(ls.get(j).getFmlcScorePass()== 21 || ls.get(j).getFmlcScorePass() == 20) {   
                                                                                %>
                                                                                <p> <%=ls.get(j).getFmlcScoreMsg()%></p>
                                                                                <p><%=ls.get(j).getFmlcSuggestMsg()%></p>
                                                                                <%
                                                                             }else if(ls.get(j).getFmlcScorePass() == 24){
                                                                                 medPass = 1;
                                                                             }
                                                                        }
                                                                    }
                                                                    ...
                                                                    if(medPass == 1){
                                                                        if (ls.get(j).getFmlcDifficulty().equalsIgnoreCase("hard")){
                                                                            if(ls.get(j).getFmlcSessionPass() == 30){
                                                                                %>
                                                                                <p> <%=ls.get(j).getFmlcSessionMsg()%></p>
                                                                                <%
                                                                            }else if(ls.get(j).getFmlcScorePass()== 31 || ls.get(j).getFmlcScorePass() == 30) {   
                                                                                %>
                                                                                <p> <%=ls.get(j).getFmlcScoreMsg()%></p>
                                                                                <p><%=ls.get(j).getFmlcSuggestMsg()%></p>
                                                                                <%
                                                                             }else if(ls.get(j).getFmlcScorePass() == 34){
                                                                                 hardPass = 1;
                                                                             }
                                                                        }
                                                                    }
